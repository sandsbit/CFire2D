...
#ifndef INVALID_AUDIO_FILE_FORMAT_H
#define INVALID_AUDIO_FILE_FORMAT_H
...
namespace c2d::exceptions {
 ...
 class invalid_audio_file_format  : public boost::exception, public std::exception {
  [[nodiscard]] const char *what() const noexcept override;
 };

}

#endif //INVALID_AUDIO_FILE_FORMAT_H
