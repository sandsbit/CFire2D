...
You will be able to download first version [here](https://github.com/sandsbit/CFire2D/releases/).
## C++ standart and compilers support
This lib is written with C++20 in mind, so you need a modern compiler.
C++20 features that may be used:
* Concepts
...
Also, feel free to update or translate project's [GitHub wiki](https://github.com/sandsbit/CFire2D/wiki) or send your
ideas and proposals [here](https://github.com/sandsbit/CFire2D/issues/new?assignees=sandsbit&labels=enhancement&template=feature_request.md&title=).
## License
![GNU LGPL v3 logo](https://www.gnu.org/graphics/lgplv3-with-text-154x68.png)

CFire 2D is free software: you can redistribute it and/or modify
it under the terms of the GNU Lesser General Public License as
published by the Free Software Foundation, either version 3 of
the License, or (at your option) any later version.

CFire 2D is distributed in the hope that it will be useful,
...
* [Latest non-stable source code](https://github.com/sandsbit/CFire2D/tree/develop)
* [GNU LGPL v3 text](https://github.com/sandsbit/CFire2D/blob/master/LICENSE)
* [GNU GPL v3 text](https://github.com/sandsbit/CFire2D/blob/master/LICENSE.GPL)
* [Documentation](https://github.com/sandsbit/CFire2D/wiki)
* [Report bug](https://github.com/sandsbit/CFire2D/issues)
## Authors and copyright
Copyright (C) 2025 Nikita S., All Rights Reserved<br>
